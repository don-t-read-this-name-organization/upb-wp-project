...
const messages = {
  en: {
    ...
    linksPage:{
      ...
      intl: { title: 'International Students', desc: 'Information for international students at FILS' },
  ...
  intl: { title: 'Internationale Studierende', desc: 'Informationen für internationale Studierende an der FILS' },
  portal: { title: 'Studierendenportal', desc: 'Allgemeine Informationen und Dienste für Studierende' },
  activities: { title: 'Studentische Aktivitäten', desc: 'Aktivitäten und Veranstaltungen für Studierende' },
  associations: { title: 'Studierendenvereinigungen', desc: 'Treten Sie studentischen Organisationen und Clubs bei' },
  ...
  intl: { title: 'Étudiants Internationaux', desc: 'Informations pour les étudiants internationaux à la FILS' },
  portal: { title: 'Portail Étudiant', desc: 'Informations générales et services aux étudiants' },
  activities: { title: 'Activités Étudiantes', desc: 'Activités et événements pour les étudiants' },
  associations: { title: 'Associations Étudiantes', desc: 'Rejoignez des organisations et clubs étudiants' },
  ...
  courses: { title: 'Cours en ligne', desc: 'Plateforme d\'apprentissage en ligne et supports de cours' },
