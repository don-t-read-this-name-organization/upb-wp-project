error id: file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/exception/GlobalExceptionHandler.java:_empty_/MethodArgumentNotValidException#getBindingResult#getFieldErrors#
file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/exception/GlobalExceptionHandler.java
empty definition using pc, found symbol in pc: _empty_/MethodArgumentNotValidException#getBindingResult#getFieldErrors#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2524
uri: file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/exception/GlobalExceptionHandler.java
text:
```scala
