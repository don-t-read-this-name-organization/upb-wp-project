error id: file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/controller/UserController.java:org/unimate/unimate/domain/entities/User#
file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/controller/UserController.java
empty definition using pc, found symbol in pc: org/unimate/unimate/domain/entities/User#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 769
uri: file:///F:/uni/projects/upb-wp-project/unimate_backend/src/main/java/org/unimate/unimate/api/controller/UserController.java
text:
```scala
